   ...
   const handleBase64 = (e) => {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        ...
        if (selectedImage !== "") {
          requestBody.blogSelectedImage = selectedImage;
        }
    
        const response = await fetch(
          `http://localhost:4000/editblogproduct/${id}`,
          {
            method: "PUT",
            headers: {
                ...
                <form onSubmit={handleSubmit}>
                  <div className="inputArea">
                    ...
                    <input
                      ...
                      value={retrieveData.blogDescription}
                      onChange={handleChange}
                    />
                    <input
                      type="number"
